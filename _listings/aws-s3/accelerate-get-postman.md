{
  "info": {
    "name": "AWS S3 GET Bucket accelerate",
    "_postman_id": "5a8dfcca-3297-4351-a335-62815ad62f67",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "3acc2de9-2ec6-429f-895f-03c91c14cd5f",
          "name": "put-bucket",
          "request": {
            "url": "{{default}}/",
            "method": "PUT",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "e53ee627-3d99-4055-8a2c-741cd6f5764d"
            }
          ]
        },
        {
          "id": "2e4e0c0f-6da5-4642-a2fb-d344eb10f10b",
          "name": "delete-bucket",
          "request": {
            "url": "{{default}}/",
            "method": "DELETE",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "698a34bf-a2fb-4049-a017-c1aa0aa39796"
            }
          ]
        },
        {
          "id": "15f8f7fd-2b00-4298-8503-16b68b1ced4c",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "0e805b18-e989-476e-a8ff-cbef92d27f93"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "d4f8ccf3-6701-4fd8-ab81-39cf2660e08f",
          "name": "post-object",
          "request": {
            "url": "{{default}}/",
            "method": "POST",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "b9cc4b3b-75e9-4b79-aa79-760ae1b99529"
            }
          ]
        }
      ]
